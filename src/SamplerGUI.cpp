...
SamplerGUI::SamplerGUI (StateManager& stateManager, std::string synthInstance) : SynthGUI (stateManager, synthInstance)
{
    ...
    addEquinoxSlider (std::make_shared<EquinoxSlider> (stateManager, Slider::SliderStyle::RotaryHorizontalVerticalDrag, 0.0f, 100.0f, 40, 40, "sampleStartTime" + synthInstance, "Start time"));
}
...
void SamplerGUI::resized()
{
    ...
    EquinoxSlider& sampleStartSlider = *getSlider ("sampleStartTime" + synthInstance);
