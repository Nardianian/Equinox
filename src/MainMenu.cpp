...
MainMenu::MainMenu (PresetManager& presetManager) : backArrow ("back", 0.5, Colours::black), forwardArrow ("forward", 0.0, Colours::black), presetManager (presetManager)
{
    ...
    menuScreen = ImageCache::getFromMemory (Resources::MenuScreen_png, Resources::MenuScreen_pngSize);
    screenReflection = ImageCache::getFromMemory (Resources::MenuScreenReflection_png, Resources::MenuScreenReflection_pngSize);

    menuFont = Font (Typeface::createSystemTypefaceFor (Resources::_8bit_fortress_ttf, Resources::_8bit_fortress_ttfSize));
