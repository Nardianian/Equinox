...
OscillatorGUI::OscillatorGUI (StateManager& stateManager, std::string synthInstance) : SynthGUI (stateManager, synthInstance)
{
    ...
    // Phase slider
    addEquinoxSlider (std::make_shared<EquinoxSlider> (stateManager, Slider::SliderStyle::RotaryHorizontalVerticalDrag, 0.0f, 100.0f, 40, 40, "phase" + synthInstance, "Phase"));
}
...
void OscillatorGUI::resized()
{
    ...
    EquinoxSlider& phaseSlider = *getSlider ("phase" + synthInstance);
