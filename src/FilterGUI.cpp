...
{
    addEquinoxSlider (std::make_shared<EquinoxSlider> (stateManager, Slider::SliderStyle::RotaryHorizontalVerticalDrag, 5.0f, 22050.0f, 70, 70, "cutoff" + synthInstance, "Cutoff", "Hz"));

    addEquinoxSlider (std::make_shared<EquinoxSlider> (stateManager, Slider::SliderStyle::RotaryHorizontalVerticalDrag, 0.0f, 100.0f, 50, 50, "drive" + synthInstance, "Drive"));

    addEquinoxSlider (std::make_shared<EquinoxSlider> (stateManager, Slider::SliderStyle::RotaryHorizontalVerticalDrag, 0.0f, 100.0f, 70, 70, "resonance" + synthInstance, "Resonance"));
