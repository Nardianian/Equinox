...
public:
    ...
    EquinoxSlider (StateManager& state, Slider::SliderStyle sliderStyle, float minSliderValue, float maxSliderValue, int sliderWidth, int sliderHeight, String paramID, String labelText, String valueSuffix = "", String valuePrefix = "", unsigned int valueMaxDecimals = 0);
