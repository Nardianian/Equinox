...
//==============================================================================
EquinoxSlider::EquinoxSlider (StateManager& state, Slider::SliderStyle sliderStyle, float minSliderValue, float maxSliderValue, int sliderWidth, int sliderHeight, String paramID, String labelText, String valueSuffix, String valuePrefix, unsigned int valueMaxDecimals) : parameterID (paramID), suffix (valueSuffix), prefix (valuePrefix), minValue (minSliderValue), maxValue (maxSliderValue), maxDecimals (valueMaxDecimals)
{
...
Rectangle<int> EquinoxSlider::getSliderComponentBounds() const
{
...
Rectangle<int> EquinoxSlider::getLabelComponentBounds() const
{
