...
{
    rotaryKnob = ImageCache::getFromMemory (Resources::RotaryKnob_png, Resources::RotaryKnob_pngSize);
    rotaryKnobShadow = ImageCache::getFromMemory (Resources::RotaryKnobShadow_png, Resources::RotaryKnobShadow_pngSize);

    sliderKnob = ImageCache::getFromMemory (Resources::SmallSliderKnob_png, Resources::SmallSliderKnob_pngSize);
    sliderLine = ImageCache::getFromMemory (Resources::SliderLine_png, Resources::SliderLine_pngSize);

    buttonUp = ImageCache::getFromMemory (Resources::BtnUp1_png, Resources::BtnUp1_pngSize);
    buttonDown = ImageCache::getFromMemory (Resources::BtnDown1_png, Resources::BtnDown1_pngSize);
}
